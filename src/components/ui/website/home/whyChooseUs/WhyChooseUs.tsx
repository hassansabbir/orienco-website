  ...
  return (
    <Section className="py-20 bg-black">
      <div className="container mx-auto">
        <Typography
          variant="h1"
          className="text-white mb-16 italic font-bold max-w-4xl leading-tight"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div>
              <Typography
                variant="h3"
                className="text-white italic mb-6 text-2xl"
              >
              ...
              >
                Contact us to check availability and reserve your preferred car
                with quick confirmation. Choose hourly, daily, or monthly rental
                options with simple and transparent pricing.
              </Typography>
            </div>
            <Link href={"/cars"}>
              <PremiumButton variant="white" className="w-full cursor-pointer">
                See All Cars
              </PremiumButton>
            </Link>
          </motion.div>
          ...
          >
            <div>
              ...
              <Typography
                ...
                className="text-white/60 mb-8 leading-relaxed"
              >
                Drive from a wide range of luxury, sports, and economy cars, all
                professionally well-maintained to ensure maximum comfort,
                safety, reliability, and top-tier performance on every journey.
              </Typography>
            </div>
            <Link href={"/cars"}>
              <PremiumButton variant="white" className="w-full cursor-pointer">
